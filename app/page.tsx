    ...
    <div className="min-h-screen p-4 md:p-6 lg:p-8">
      <div className="max-w-[1600px] mx-auto space-y-6">
        ...
        <Header
          ...
          onRiskThresholdsChange={setRiskThresholds}
        />
        ...
        <Tabs defaultValue="overview" className="space-y-6">
          <TabsList className="grid h-auto w-full grid-cols-2 gap-1 rounded-xl border border-primary/20 bg-background/60 p-1 sm:grid-cols-4">
            <TabsTrigger value="overview" className="py-2.5 font-mono text-xs uppercase tracking-wider">
              Overview
            </TabsTrigger>
            <TabsTrigger value="monitoring" className="py-2.5 font-mono text-xs uppercase tracking-wider">
              Live Monitoring
            </TabsTrigger>
            <TabsTrigger value="forecast" className="py-2.5 font-mono text-xs uppercase tracking-wider">
              Forecast
            </TabsTrigger>
            <TabsTrigger value="comparison" className="py-2.5 font-mono text-xs uppercase tracking-wider">
              Airport Comparison
            </TabsTrigger>
          </TabsList>
        ...
        {weatherData && (
          <div>
            ...
            <RunwayAnalysis 
              windSpeed={weatherData.current.windSpeed}
              windDirection={Math.abs(Math.round(selectedAirport.latitude * 10 + selectedAirport.longitude * 10)) % 360}
            />
          </div>
        )}
          </TabsContent>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-3 text-xs font-mono">
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-blue-300">LOCAL DATA ACTIVE</span>
              </div>
              {isDemoMode && (
                <div className="flex items-center gap-2">
